...
|---|---|---|---|
| Mastery-Only Baseline | 0.5000 | 0.6371 | 0.0895 |
| +Temporal (GRU) | 0.5000 | 0.5443 | 0.0936 |
| Full UMiKT-GAT | 0.5000 | 0.5949 | 0.1005 |
| BKT Baseline | 0.0533 | N/A | 0.8765 |
| DKT Baseline | 0.9993 | N/A | 0.1279 |
...
|---|---|---|
| +Temporal only | 0.5000 | 0.5443 |
| +Graph (GAT added) | 0.5000 | 0.6579 |
